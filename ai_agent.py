...
# Step 1: Create an AI Agent & Link to backend using Gemini
...
class GeminiLLM:
    ...
    def __call__(self, messages):
        # Expecting messages as a list of dicts: [{"role": ..., "content": ...}, ...]
...
llm = GeminiLLM(model_name="gemini-1.5-flash", temperature=0.2)
...
if __name__ == "__main__":
    print("Mental Health AI Agent running. Type your message or 'exit' to quit.")
    while True:
        user_input = input("User: ")
        if user_input.lower() in ("exit", "quit"):
            break
        inputs = {"messages": [{"role": "system", "content": SYSTEM_PROMPT}, {"role": "user", "content": user_input}]}
